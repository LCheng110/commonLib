...
/* package */public final class AndroidExecutors {
  ...
  /* package */ public static final int CORE_POOL_SIZE = CPU_COUNT + 1;
  /* package */ public static final int MAX_POOL_SIZE = CPU_COUNT * 2 + 1;
  /* package */ public static final long KEEP_ALIVE_TIME = 1L;
  ...
  public static ExecutorService newCachedThreadPool() {
    ...
    Logger.d("", "core pool size = " + CORE_POOL_SIZE);
    return executor;
  }
