...
import com.qiniu.android.jpush.utils.AsyncRun;
...
public final class QiniuUploadManager {
    ...
    public QiniuUploadManager(Recorder recorder, KeyGenerator keyGen) {
        this.recorder = recorder;
        this.httpManager = new HttpManager();
        this.keyGen = keyGen;
    }

    public QiniuUploadManager(Recorder recorder) {
        this(recorder, null);
    }
