...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == PictureConfig.TYPE_CAMERA) {
            ...
            if (pictureType.startsWith(PictureConfig.VIDEO) || selectMode == PictureConfig.SINGLE) {
    ...
    private void notifyCheckChanged(ViewHolder viewHolder, LocalMedia imageBean) {
        ...
        for (LocalMedia media : selectImages) {
            if (media != null && media.getPath() != null
                    && imageBean != null && imageBean.getPath() != null
                    && media.getPath().equals(imageBean.getPath())) {
            ...
            if (media.getPictureType().startsWith(PictureConfig.VIDEO)) {
