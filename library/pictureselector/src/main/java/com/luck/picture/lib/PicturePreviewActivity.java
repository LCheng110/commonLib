...
public class PicturePreviewActivity extends PictureBaseActivity implements View.OnClickListener, Animation.AnimationListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ll_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (images != null && images.size() > 0) {
                    ...
                    if (PictureFileUtils.isDownLoading(image.getPath())) {
                        ToastUtils.showLong(getResources().getText(R.string.picture_error_suffix), getApplicationContext());
                        return;
                    }
                    ...
                    if (!TextUtils.isEmpty(pictureType)) {
                        if (pictureType.startsWith("video") && image.getPictureType().startsWith("video")) {
                            showToast(getString(R.string.video_rule));
                            return;
                        }
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                ...
                View convertView = viewPager.findViewWithTag("view" + viewPager.getCurrentItem());
                videoView = convertView.findViewById(R.id.video_view);
                videoView.setVideoPath(media.getPath());
                videoView.start();
                lastIndex = i;

                Log.d("yangfeng", "onPageSelected position == " + i + " , convertView == " + convertView + " , videoView == " + videoView);
            }
    ...
    private boolean isCurVideo() {
        ...
        return media.getPictureType().startsWith(PictureConfig.VIDEO);
    }

    /**
     * 文件类型是视频的时候只显示"确定"，不显示具体数量
     */
    private void updateOkPanel() {
        boolean isCurVideo = isCurVideo();
        tv_ok.setVisibility(isCurVideo ? View.GONE : View.VISIBLE);
    }
    ...
    public class SimpleFragmentAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            final VideoView videoView = contentView.findViewById(R.id.video_view);


            contentView.setTag("view" + position);

            Log.d("yangfeng", "instantiateItem position == " + position + " , convertView == " + contentView + " , videoView == " + videoView);
            //Log.d("yf", "position == " + position + " instantiateItem, imageView == " + imageView + " , videoView == " + videoView);
            ...
            if (media != null) {
                ...
                if (eqVideo) {
                    ...
                    videoView.setBackgroundColor(container.getContext().getResources().getColor(R.color.black));
                    videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mp) {
                            Log.i("yf", "videoView onCompletion");
                        }
                    });
