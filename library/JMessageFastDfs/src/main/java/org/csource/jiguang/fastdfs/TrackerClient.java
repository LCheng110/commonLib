...
public class TrackerClient {
    ...
    public StorageServer getStoreStorage(TrackerServer trackerServer, String groupName) throws IOException {
        ...
        if (ClientGlobal.g_custom_storage_upload) {
            ip_addr = ClientGlobal.g_custom_storage_upload_host;
            port = ClientGlobal.g_custom_storage_upload_port;
            System.out.println("custom storage ip addr = " + ip_addr + " port = " + port + " store_path = " + store_path);
        } else {
            ...
            try {
                ...
                System.out.println("storage from tracker. ip addr = " + ip_addr + " port = " + port + " store_path = " + store_path);
