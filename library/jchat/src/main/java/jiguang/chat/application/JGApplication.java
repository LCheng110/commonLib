...
public class JGApplication extends com.activeandroid.app.Application {
    ...
    public static final int TAKE_REWARD = 8;
    ...
    public static final String TARGET_WEB_CHAT = "jsBridge";
	...
	public void onCreate() {
        ...
        VideoPlayerManager.get().init(this);
	}
	...
	public void initActiveAndroid() {
		// ActiveAndroid为了兼容5.0以上的手机，需添加下面的代码
