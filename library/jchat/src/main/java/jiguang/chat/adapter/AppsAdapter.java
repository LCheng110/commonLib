...
public class AppsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.root = convertView.findViewById(R.id.ll_root);
        ...
        if (appBean != null) {
			...
			if (appBean.getFuncName().equals("图片")) {
				...
				//viewHolder.root.setBackgroundColor(Color.parseColor("#F2F4F5"));
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //加上礼物
                    else if (appBean.getFuncName().equals("打赏")){
                        EventBus.getDefault().post(new ImageEvent(JGApplication.TAKE_REWARD));
                    }
                }
            });
        }
