...
public class SimpleAppsGridView extends RelativeLayout {
    ...
    protected void init() {
        ...
        mAppBeanList.add(new AppBean(R.drawable.ic_chat_image, "图片"));
        mAppBeanList.add(new AppBean(R.drawable.ic_chat_camera, "拍摄"));
        //mAppBeanList.add(new AppBean(R.mipmap.icon_file, "文件"));
        mAppBeanList.add(new AppBean(R.drawable.ic_chat_location, "位置"));
        //添加打赏
//        mAppBeanList.add(new AppBean(R.drawable.ic_chat_image,"打赏"));
