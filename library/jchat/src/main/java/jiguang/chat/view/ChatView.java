...
//        }
    ...
    public void setListenersGroup(BaseFragment fragment){
        mReturnButton.setOnClickListener((OnClickListener) fragment);
        mRightBtn.setOnClickListener((OnClickListener) fragment);
        mAtMeBtn.setOnClickListener((OnClickListener) fragment);
    }
