...
/**
 * Created by zhaoyuanchao on 2018/8/16.
 */

public class IMCircleImageView extends ImageView {
    ...
    public IMCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IMCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CropImageView, defStyle, 0);
