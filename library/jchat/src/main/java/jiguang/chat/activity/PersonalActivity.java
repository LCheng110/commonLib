    ...
    public void onClick(View v) {
		...
		if (i == R.id.iv_photo) {//头像
			if ((ContextCompat.checkSelfPermission(PersonalActivity.this, Manifest.permission.CAMERA) !=
					...
					(ContextCompat.checkSelfPermission(PersonalActivity.this, Manifest.permission
...
//			TimePickerView timePickerView = new TimePickerView.Builder(PersonalActivity.this, new TimePickerView
