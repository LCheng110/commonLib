        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
				...
				if (i == R.id.btn_refusal) {//拒绝添加
					dialog.show();
					ContactManager.declineInvitation(mToUserInfo.getUserName(), mToUserInfo.getAppKey(), "拒绝了您的好友请求",
							new BasicCallback() {
						@Override
					...
					dialog.show();
					ContactManager.acceptInvitation(mToUserInfo.getUserName(), mToUserInfo.getAppKey(), new
							BasicCallback() {
						@Override
						public void gotResult(int responseCode, String responseMessage) {
							dialog.dismiss();
