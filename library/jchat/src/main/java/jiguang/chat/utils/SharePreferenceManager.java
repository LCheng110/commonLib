...
public class SharePreferenceManager {
    ...
    private static final String FLASH_CHAT_BROWSE = "flash_chat_browse";

    public static void setFlashChatBrowse(boolean isBrowse) {
        if (null != sp) {
            sp.edit().putBoolean(FLASH_CHAT_BROWSE, isBrowse).apply();
        }
    }

    public static boolean getFlashChatBrowse() {
        if (null != sp) {
            return sp.getBoolean(FLASH_CHAT_BROWSE, false);
        }
        return false;
    }
