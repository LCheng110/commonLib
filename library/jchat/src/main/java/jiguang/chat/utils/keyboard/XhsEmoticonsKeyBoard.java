...
public class XhsEmoticonsKeyBoard extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    protected ImageView mBtnFunctionOrInput;
    ...
    protected RelativeLayout mRlInputView;
    protected FrameLayout mFlFunctionView;
    ...
    protected void initView() {
        mBtnFunctionOrInput = ((ImageView) findViewById(R.id.btn_function_or_input));
        ...
        mRlInputView = ((RelativeLayout) findViewById(R.id.rl_input_view));
        mFlFunctionView = ((FrameLayout) findViewById(R.id.fl_function_view));
...
//        mBtnVoiceOrText.setOnClickListener(this);
    ...
    public void switchFunInput() {
        if (mRlInputView.isShown()) {
            setFunctionShow();
        } else {
            mBtnFunctionOrInput.setImageResource(R.drawable.ic_chat_function);
            showInput();
        }
    }

    public void setFunctionShow() {
        mBtnFunctionOrInput.setImageResource(R.drawable.ic_chat_message);
        showFunction();
        reset();
    }

    protected void showFunction() {
        mRlInputView.setVisibility(GONE);
        mFlFunctionView.setVisibility(VISIBLE);
    }

    protected void showInput() {
        mRlInputView.setVisibility(VISIBLE);
        mFlFunctionView.setVisibility(GONE);
    }

    public void setFunctionOrInputShow(View functionView) {
        mBtnFunctionOrInput.setVisibility(VISIBLE);
        mFlFunctionView.addView(functionView);
    }

    public ImageView getFunctionOrInput() {
        return mBtnFunctionOrInput;
    }
