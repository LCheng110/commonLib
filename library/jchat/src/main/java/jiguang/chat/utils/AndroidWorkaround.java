...
/**
 * Created by zhaoyuanchao on 2018/10/26.
 */
...
public class AndroidWorkaround {
    ...
    private AndroidWorkaround(View content){
        ...
        frameLayoutParams = mClidOfContent.getLayoutParams();
    }
    ...
    private int computeUsableHeight() {
        Rect r = new Rect();
        mClidOfContent.getWindowVisibleDisplayFrame(r);
        return (r.bottom);
    }
