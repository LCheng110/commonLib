 ...
 */
public final class ItemBinding<T extends OnListBinding> {
     ...
     */
    public static <T extends OnListBinding> ItemBinding<T> of(int variableId, @LayoutRes int layoutRes) {
     ...
     * @see OnItemBind
     */
    public static <T extends OnListBinding> ItemBinding<T> of(OnItemBind<T> onItemBind) {
        if (onItemBind == null) {
