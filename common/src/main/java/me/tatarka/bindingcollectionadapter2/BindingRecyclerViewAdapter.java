 ...
 * list.
 */
public class BindingRecyclerViewAdapter<T extends OnListBinding> extends RecyclerView.Adapter<ViewHolder> implements BindingCollectionAdapter<T> {
    ...
    private IItemDataBinding iItemDataBinding;

    public IItemDataBinding getIItemDataBinding() {
        return iItemDataBinding;
    }

    public void setIItemDataBinding(IItemDataBinding iItemDataBinding) {
        this.iItemDataBinding = iItemDataBinding;
    }
    ...
    public void onBindBinding(ViewDataBinding binding, int variableId, @LayoutRes int layoutRes, int position, T item) {
        if (itemBinding.bind(binding, item)) {
            if (iItemDataBinding != null) {
                iItemDataBinding.setItemDataBinding(binding, position);
            }
    ...
    public final void onBindViewHolder(ViewHolder viewHolder, int position) {
		L.d("BindingRecyclerViewAdapter", "onBindViewHolder, position = " + position);
    ...
    public void onBindViewHolder(ViewHolder holder, int position, List<Object> payloads) {
		L.i("BindingRecyclerViewAdapter", "onBindViewHolder payloads, position = " + position);
    ...
    private static class WeakReferenceOnListChangedCallback<T extends OnListBinding> extends ObservableList.OnListChangedCallback<ObservableList<T>> {
