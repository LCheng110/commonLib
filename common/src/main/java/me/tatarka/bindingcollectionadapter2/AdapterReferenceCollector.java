...
class AdapterReferenceCollector {
     ...
     */
    static <T extends OnListBinding, A extends BindingCollectionAdapter<T>> WeakReference<A> createRef(A adapter, ObservableList<T> items, ObservableList.OnListChangedCallback callback) {
    ...
    static class AdapterRef<T extends OnListBinding, A extends BindingCollectionAdapter<T>> extends WeakReference<A> {
