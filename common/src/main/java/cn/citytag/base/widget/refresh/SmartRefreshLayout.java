package cn.citytag.base.widget.refresh;
...
import cn.citytag.base.widget.refresh.api.DefaultRefreshFooterCreator;
import cn.citytag.base.widget.refresh.api.DefaultRefreshHeaderCreator;
import cn.citytag.base.widget.refresh.api.RefreshContent;
import cn.citytag.base.widget.refresh.api.RefreshFooter;
import cn.citytag.base.widget.refresh.api.RefreshHeader;
import cn.citytag.base.widget.refresh.api.RefreshInternal;
import cn.citytag.base.widget.refresh.api.RefreshKernel;
import cn.citytag.base.widget.refresh.api.RefreshLayout;
import cn.citytag.base.widget.refresh.api.ScrollBoundaryDecider;
import cn.citytag.base.widget.refresh.constant.DimensionStatus;
import cn.citytag.base.widget.refresh.constant.RefreshState;
import cn.citytag.base.widget.refresh.constant.SpinnerStyle;
import cn.citytag.base.widget.refresh.footer.BallPulseFooter;
import cn.citytag.base.widget.refresh.header.BezierRadarHeader;
import cn.citytag.base.widget.refresh.impl.RefreshContentWrapper;
import cn.citytag.base.widget.refresh.impl.RefreshFooterWrapper;
import cn.citytag.base.widget.refresh.impl.RefreshHeaderWrapper;
import cn.citytag.base.widget.refresh.listener.OnLoadMoreListener;
import cn.citytag.base.widget.refresh.listener.OnMultiPurposeListener;
...
import cn.citytag.base.widget.refresh.listener.OnStateChangedListener;
import cn.citytag.base.widget.refresh.util.DelayedRunnable;
import cn.citytag.base.widget.refresh.util.DensityUtil;
import cn.citytag.base.widget.refresh.util.ScrollBoundaryUtil;
import cn.citytag.base.widget.refresh.util.ViscousFluidInterpolator;
...
import static cn.citytag.base.widget.refresh.util.DensityUtil.dp2px;
import static cn.citytag.base.widget.refresh.util.SmartUtil.fling;
import static cn.citytag.base.widget.refresh.util.SmartUtil.getColor;
import static cn.citytag.base.widget.refresh.util.SmartUtil.isScrollableView;
...
//        return setHeaderHeightPx(dp2px(heightDp));
    ...
    public void setColor() {
        if (mRefreshHeader != null) {
            mRefreshHeader.getView().setBackgroundColor(Color.TRANSPARENT);
        }
    }
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     * 设置多功能监听器
     *
     * @param listener 建议使用 {@link cn.citytag.base.widget.refresh.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
     ...
     * 设置滚动边界
     *
     * @param boundary 建议使用 {@link cn.citytag.base.widget.refresh.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
