...
/**
 * Created by yuhuizhong on 2018/9/7.
 */
...
public class UCRippleView extends FrameLayout {
    ...
    public UCRippleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UCRippleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mRippleStrokeWidth = ta.getFloat(R.styleable.RippleView_ripple_strokeWidth, DEFAULT_STROKE_WIDTH);//颜色
        mRippleDuration = ta.getInt(R.styleable.RippleView_ripple_duration, DEFAULT_DURATION);//速度
        mRippleAmount = ta.getInt(R.styleable.RippleView_ripple_count, DEFAULT_AMOUNT); //圈数
        mRippleScale = ta.getFloat(R.styleable.RippleView_ripple_scale, DEFAULT_SCALE); //中间缩放
