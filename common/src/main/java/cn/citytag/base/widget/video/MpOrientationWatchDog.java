 ...
 * 屏幕方向监听类
 */
public class MpOrientationWatchDog {
    private static final String TAG = MpOrientationWatchDog.class.getSimpleName();
    ...
    public MpOrientationWatchDog(Context context) {
