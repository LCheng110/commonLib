...
/**
 * Created by yangfeng01 on 2018/3/28.
 * <p>
 * 自适应高度的LinearLayoutManager
 */
public class FullyLinearLayoutManager extends LinearLayoutManager {
	...
	public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
		...
		if (view != null && overScrollMode == ViewCompat.OVER_SCROLL_IF_CONTENT_SCROLLS) {
			final boolean fit = (vertical && (!hasHeightSize || height < heightSize)) || (!vertical && (!hasWidthSize
					|| width < widthSize));
	...
	private void logMeasureWarning(int child) {
		L.d("LinearLayoutManager",
				"Can't measure child #" + child + ", previously used dimensions will be reused."
						+ "To remove this message either use #setChildSize() method or don't run RecyclerView "
						+ "animations");
	}
