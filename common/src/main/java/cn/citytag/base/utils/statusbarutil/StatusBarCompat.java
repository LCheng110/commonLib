package cn.citytag.base.utils.statusbarutil;
...
public class StatusBarCompat {
    ...
    public static void setStatusBarColor(Activity activity, @ColorInt int color, boolean lightStatusBar) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            setStatusBarColor(activity.getWindow(), Color.parseColor("#000000"), lightStatusBar);
        }

    }

    /**
     * @param view 隐藏5.0的top_view
     */
    public static void goneTopView(View view) {
        if (view == null) return;
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
