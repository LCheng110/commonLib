...
/**
 * Created by liguangchun on 2018/3/9.
 */
...
public final class ToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(BaseConfig.getContext().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(BaseConfig.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(BaseConfig.getContext(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(BaseConfig.getContext());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) BaseConfig.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public static void showCusBgMsgColorAndGravityToast(String bgColor
        ...
        showLong(content, BaseConfig.getContext());
    }
